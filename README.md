...
## Setup (Local)
1. Open project folder and create/activate venv:  
   - **Windows:** `python -m venv venv` → `venv\Scripts\activate`  
   - **macOS/Linux:** `python -m venv venv` → `source venv/bin/activate`  
2. Install dependencies: `pip install -r requirements.txt`  
3. Create `.env` in project root (do **not** commit):  
...
2. Add repository secrets in Settings → Secrets: `EMAIL`, `PASSWORD` (optional: `BASE_URL`, `HEADLESS`)  
